...
@section('content')
    ...
    <!-- Modal pecho -->
    <div class="modal fade" id="pechoModal" tabindex="-1" aria-labelledby="pechoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pechoModalLabel">Pecho</h5>
                ...
                <div class="modal-body">
                    ...
                    <div id="resultadosPecho">
                        <h4>Has superado al <span id="pecho-porcentaje">{{ $porcentajeSuperadoPecho }}</span>% de los
                            usuarios en pecho</h4>
                    </div>
                </div>
    ...
    <!--MODAL HOMBRO -->
    <div class="modal fade" id="hombroModal" tabindex="-1" aria-labelledby="hombroModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="hombroModalLabel">Hombro</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Aquí va el contenido del modal -->
                    <div id="resultadosHombro">
                        <h4>Has superado al <span id="hombro-porcentaje">{{ $porcentajeSuperadoHombro }}</span>% de los
                            usuarios en Hombro</h4>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <!--MODAL PIERNA -->
    <div class="modal fade" id="piernaModal" tabindex="-1" aria-labelledby="piernaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="piernaModalLabel">Biceps</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Aquí va el contenido del modal -->
                    <div id="resultadosPierna">
                        <h4>Has superado al <span id="pierna-porcentaje">{{ $porcentajeSuperadoPierna }}</span>% de los
                            usuarios en Pierna</h4>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <!--MODAL BICEPS -->
    <div class="modal fade" id="bicepsModal" tabindex="-1" aria-labelledby="bicepsModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bicepsModalLabel">Biceps</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Aquí va el contenido del modal -->
                    <div id="resultadosBiceps">
                        <h4>Has superado al <span id="biceps-porcentaje">{{ $porcentajeSuperadoBiceps }}</span>% de los
                            usuarios en Biceps</h4>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
    ...
    <div class="container-fluid">
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col" class="btn btn-primary" data-toggle="modal" data-target="#pechoModal"
                    style="cursor:pointer;">
                    <img src="https://www.shareicon.net/data/128x128/2016/06/18/596432_torso_512x512.png" alt="">
                </div>
                <div class="col" class="btn btn-primary" data-toggle="modal" data-target="#bicepsModal"
                    style="cursor:pointer;">
                    <img src="https://www.shareicon.net/data/128x128/2016/06/18/596479_hand_512x512.png" alt="">
                </div>


                <div class="col" class="btn btn-primary" data-toggle="modal" data-target="#piernaModal"
                    style="cursor:pointer;">
                    <img src="https://cdn-icons-png.flaticon.com/512/5850/5850570.png" style="width: 53%;"
                        alt="">
                </div>
                <div class="col" class="btn btn-primary" data-toggle="modal" data-target="#hombroModal"
                    style="cursor:pointer;">
                    <img src="https://cdn-icons-png.flaticon.com/512/787/787343.png" style="width: 53%;" alt="">
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderChart(chartType, selectedDay) {
                const data = porcentajesPorDia[selectedDay] || {
                    pecho: 0,
                    biceps: 0,
                    pierna: 0,
                    hombro: 0
            ...
            document.getElementById('resultadosHombro').addEventListener('change', function() {
                var selectedDay = this.value;
                var selectedType = document.getElementById('chartType').value;
                renderChart(selectedType, selectedDay);
            });

            document.getElementById('resultadosBiceps').addEventListener('change', function() {
                var selectedDay = this.value;
                var selectedType = document.getElementById('chartType').value;
                renderChart(selectedType, selectedDay);
            });

            document.getElementById('resultadosPierna').addEventListener('change', function() {
                var selectedDay = this.value;
                var selectedType = document.getElementById('chartType').value;
                renderChart(selectedType, selectedDay);
            });
